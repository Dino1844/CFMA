...
import requests
from cfma.constants import IGNORE_INDEX
from cfma.conversation import get_conv
...
def _read_video_decord(ele: dict, ) -> torch.Tensor:
    ...
    # but it would affect checker's performance when video_start and video_end get clamped
