...
from cfma.constants import REG_TOKEN, SEG_E_TOKEN, SEG_S_TOKEN
from cfma.dataset import HybridDataCollator, HybridDataset
from cfma.model import MODELS
from cfma.model.builder import build_model
from cfma.train.custom_trainer import CustomTrainer
...
def train(TrainingArguments, Trainer):
    ...
    assert model_args.role in ('all_in_one', 'grounder', 'checker')
